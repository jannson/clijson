...
// by the given flag.
func NewJSONSourceFromFlagFunc(flag string) func(c *cli.Context) (altsrc.InputSourceContext, error) {
	return func(context *cli.Context) (altsrc.InputSourceContext, error) {
		if in, err := NewJSONSourceFromFile(context.String(flag)); err != nil {
			return nil, nil
		} else {
			return in, err
		}
...
// data.
func NewJSONSourceFromFile(f string) (altsrc.InputSourceContext, error) {
...
func NewJSONSourceFromReader(r io.Reader) (altsrc.InputSourceContext, error) {
...
func NewJSONSource(data []byte) (altsrc.InputSourceContext, error) {
